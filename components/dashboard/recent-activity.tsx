...
import { getComplaintStatusPresentation, getDisplayTitle } from '@/lib/complaints/display'
              ...
              <li key={complaint.id}>
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="text-foreground truncate text-sm font-medium">{displayTitle}</p>
